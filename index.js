...
//Answer - When a function is defined in another function, the innner function(nestedFunction()) have access to 
// to the outer (myFunction())function's variable by a behavior called lexical scoping. For example we can 
//compare it with one-way glass where we can see the outside (nestedFunction() can), but someone from outside (myFunction()) cannot see 
